        ...
        <div>
            ...
            <div style={{ backgroundColor: color_card_bg }} className="card card-side   md:min-w-[630px] ">
                ...
                <div className="card-body">
                    ...
                    <h2 className={`card-title text-xl md:text-[20px] font-semibold`}>{title}</h2>
                    <p style={{ color: color_text_and_button_bg }} className=" text-[16px] font-semibold">${price}</p>
                    <div className="card-actions justify-start">
                        <button style={{ backgroundColor: color_text_and_button_bg }} className="btn w-[150px]  text-white text-xs md:text-[16px] border-none  font-semibold ">View Details</button>
                    </div>
                </div>
            </div>
        </div>
